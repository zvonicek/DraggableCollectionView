Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zvonicek/DraggableCollectionView"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.authors      = [ 'Luke Scott']
  s.source       = { :git => "https://github.com/zvonicek/DraggableCollectionView.git", :tag => s.version.to_s }
  s.platform     = :ios, '6.0'
  s.requires_arc = true
